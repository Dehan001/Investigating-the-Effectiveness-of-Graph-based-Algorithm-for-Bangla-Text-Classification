...
datasets = ['BanglaErrorBin','BanglaErrorMulti','Sentiment', 'BanFake', 'BengaliHateSpeech', 'SarcasDetection', '20ng', 'R8', 'R52', 'ohsumed', 'mr',
            'SentNOB', 'Emotion']
# build corpus
dataset = sys.argv[1]
...
allx = sp.csr_matrix(
    (data_allx, (row_allx, col_allx)), shape=(train_size, word_embeddings_dim))
