...
parser.add_argument('--dataset', default='BanglaErrorBin', choices=['BanglaErrorMulti','BanglaErrorBin','Sentiment','BanFake','BengaliHateSpeech','SarcasDetection','Emotion','20ng', 'R8', 'R52', 'ohsumed', 'mr','SentNOB'])
